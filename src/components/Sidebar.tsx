...
import { LayoutDashboard, Settings, Shield, ScrollText, Radio, ChevronLeft, ChevronRight, Server, Activity } from 'lucide-react';
...
const navItems = [
  ...
  { to: '/health-config', icon: Activity, label: '健康度配置' },
];
